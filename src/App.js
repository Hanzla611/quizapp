      ...
      <div class="flex p-6 font-mono">
        <div class="flex-none w-40 relative">
          <img
            ...
            alt=""
            class="absolute inset-0 w-full h-full object-cover border border-black shadow-offset-lime"
          />
        </div>
        <form class="flex-auto pl-6">
          <div class="flex flex-wrap items-baseline pl-52 -mt-6 -mr-6 -ml-52 py-6 pr-6 bg-black text-white">
            ...
            <div class="text-2xl leading-7 font-bold">$89.00</div>
          ...
          <div class="flex items-baseline py-8">
            <div class="space-x-3.5 flex text-center text-sm leading-none font-bold text-gray-500">
              <label>
                <input
                  class="w-6 text-black shadow-underline"
                  name="size"
                  type="radio"
                  value="xs"
                  checked
              ...
              <label>
                <input class="w-6" name="size" type="radio" value="s" />S
              </label>
              <label>
                <input class="w-6" name="size" type="radio" value="m" />M
              </label>
              <label>
                <input class="w-6" name="size" type="radio" value="l" />L
              </label>
              <label>
          ...
          <div class="flex space-x-3 text-sm font-bold uppercase mb-4">
            <div class="flex-auto flex space-x-3">
              <button
                class="w-1/2 flex items-center justify-center bg-lime-300 text-black border border-black shadow-offset-black"
                type="submit"
              >
                Buy now
              </button>
              <button
                class="w-1/2 flex items-center justify-center border border-black shadow-offset-black"
                type="button"
              >
                Add to bag
              </button>
